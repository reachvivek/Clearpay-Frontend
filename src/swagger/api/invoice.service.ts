...
export class InvoiceService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public invoiceLoadFiltersGet(observe?: 'body', reportProgress?: boolean): Observable<any>;
    public invoiceLoadFiltersGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public invoiceLoadFiltersGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public invoiceLoadFiltersGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('get',`${this.basePath}/Invoice/LoadFilters`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
